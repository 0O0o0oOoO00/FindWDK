...
if (NOT DEFINED WDKContentRoot)
    ...
    foreach (key ${WINDOWS_KIT_SEARCH_REG})
        cmake_host_system_information(RESULT res
                QUERY WINDOWS_REGISTRY ${key}
                VALUE "InstallationFolder"
        )
        if (res)
            set(WDKContentRoot ${res})
            break()
        endif ()
        message(FATAL_ERROR "No windows kit found")
    endforeach ()
endif ()

file(GLOB WDK_NTDDK_FILES
        "${WDKContentRoot}/Include/*/km/ntddk.h" # WDK 10
        "${WDKContentRoot}/Include/km/ntddk.h" # WDK 8.0, 8.1
)
